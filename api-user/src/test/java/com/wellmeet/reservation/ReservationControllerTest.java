    ...
    class GetReservations {
        ...
        void 멤버의_예약_목록을_조회할_수_있다() {
            ...
            AvailableDate availableDate2 = availableDateGenerator.generate(LocalDateTime.now().plusDays(2), 10,
                    restaurant);
            reservationGenerator.generate(restaurant.getId(), availableDate.getId(), member.getId(), 4);
            reservationGenerator.generate(restaurant.getId(), availableDate2.getId(), member.getId(), 2);
