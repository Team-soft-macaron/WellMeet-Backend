...
class FavoriteControllerTest extends BaseControllerTest {
    ...
    void getFavoriteRestaurants() {
        ...
        Restaurant restaurant1 = restaurantRepository.save(
                new Restaurant("Restaurant 1", "Address 1", 38.5, 128.2, "https://example.com/restaurant1.jpg", "123"));
        Restaurant restaurant2 = restaurantRepository.save(
                new Restaurant("Restaurant 2", "Address 2", 38.5, 128.2, "https://example.com/restaurant2.jpg", "124"));
        Restaurant restaurant3 = restaurantRepository.save(
                new Restaurant("Restaurant 3", "Address 3", 38.5, 128.2, "https://example.com/restaurant3.jpg", "125"));
        ...
        FavoriteRestaurantResponse[] responses = given()
                ...
                .when().get("/api/favorite/restaurant")
