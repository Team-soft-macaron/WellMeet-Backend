...
public class ReservationResponse {
    ...
    public ReservationResponse(Reservation reservation, AvailableDate availableDate, String memberName, String memberPhone, String memberEmail, boolean memberVip) {
