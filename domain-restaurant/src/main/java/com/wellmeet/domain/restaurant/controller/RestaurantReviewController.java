...
import com.wellmeet.domain.restaurant.service.RestaurantReviewApplicationService;
...
public class RestaurantReviewController {
    ...
    private final RestaurantReviewApplicationService reviewService;

    public RestaurantReviewController(RestaurantReviewApplicationService reviewService) {
